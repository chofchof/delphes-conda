...
"""
Python translation of DelphesHepMC2 written by Jin-Hwan CHO
"""
...
ROOT.gInterpreter.Declare('#include "classes/DelphesHepMC2Reader.h"')
from ROOT import DelphesHepMC2Reader
...
def run_main(config_file: str, output_file: str, input_files: list[str]) -> None:
    ...
    reader: DelphesHepMC2Reader = DelphesHepMC2Reader()
